...
var favoriteBook = Book(title: "Diary of a Wimpy Kid", author: "Jeff Kinney", pages: 221, price: 14.99)
print(favoriteBook)
/*:
...
struct Height{
    ...
    init(heightInCentimeters2:Double){
        heightInInches = heightInCentimeters2 / 2.54
        heightInCentimeters = heightInCentimeters2
    }
}

let h = Height(heightInCentimeters2: 165.1)
 ...
 */
var someonesHeight = Height(heightInInches2: 65)
